...
from src.models import SimpleMLPWithEmbedding, PyTorchLightningModel
...
# LOGS_FOLDER = "logs_embedding_dims_TEST"

# PROD
LIT_SANITY_STEPS = 1
LIMIT = None
DATALOADER_WORKERS = 4
LOGS_FOLDER = "logs_embedding_dims"
...
if __name__ == "__main__":
    ...
    # EMBEDDED
    # ===========================================
    for embeeding_dim in EMBEDDING_DIMS:
        embedding_training(X_train_loader, X_test_loader, name=f"embedded_{embeeding_dim}", embedding_dim=embeeding_dim, positional=False, log_folder=LOGS_FOLDER, epochs=EPOCHS)
